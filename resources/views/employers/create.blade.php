<x-layout>
    <x-slot:heading>Create Company Profile</x-slot:heading>

    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl border border-gray-200 p-8">
            <h2 class="text-lg font-semibold text-gray-900 mb-1">Company Information</h2>
            <p class="text-sm text-gray-500 mb-6">Set up your company profile to start posting jobs and internships.</p>
