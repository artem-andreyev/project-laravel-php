                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                            >
                            <input type="hidden" name="latitude" id="latitude" value="{{ old('latitude', $internship->latitude) }}">
                            <input type="hidden" name="longitude" id="longitude" value="{{ old('longitude', $internship->longitude) }}">
